        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffFirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    StaffLastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Staffs_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Staffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "System", new DateTime(2023, 2, 7, 14, 57, 22, 720, DateTimeKind.Local).AddTicks(3549), new DateTime(2023, 2, 7, 14, 57, 22, 721, DateTimeKind.Local).AddTicks(4581), "Pasir Ris 51", "benyeo@gmail.com", "Ben", "Male", "Yeo", "98712345", 3, "System" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "System", new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9007), new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9018), "Support employees by assigning tasks", "Admin", "Admin", "System" },
                    { 2, "System", new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9023), new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9024), "Drive passengers to the intended destination", "Driver", "Driver", "System" }
                });

            migrationBuilder.InsertData(
                table: "VehicleCategorys",
                columns: new[] { "Id", "Capacity", "CreatedBy", "DateCreated", "DateUpdated", "Name", "Price", "UpdatedBy" },
                values: new object[] { 1, 4, "System", new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(2924), new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(2932), "Cabify Standard", 12.0, "System" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "System", new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(7783), new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(7790), "john123@gmail.com", "Jon", "Male", "Snow", "98765432", 4, 2, "System" });
