...
namespace CabifyTransportBooking.Server.Migrations
{
    ...
    [Migration("20230207065723_newdb")]
    partial class newdb
    {
            ...
            modelBuilder.Entity("CabifyTransportBooking.Shared.Domain.Passenger", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            DateCreated = new DateTime(2023, 2, 7, 14, 57, 22, 720, DateTimeKind.Local).AddTicks(3549),
                            DateUpdated = new DateTime(2023, 2, 7, 14, 57, 22, 721, DateTimeKind.Local).AddTicks(4581),
            ...
            modelBuilder.Entity("CabifyTransportBooking.Shared.Domain.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            DateCreated = new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(7783),
                            DateUpdated = new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(7790),
            ...
            modelBuilder.Entity("CabifyTransportBooking.Shared.Domain.StaffRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            DateCreated = new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9007),
                            DateUpdated = new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9018),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "System",
                            DateCreated = new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9023),
                            DateUpdated = new DateTime(2023, 2, 7, 14, 57, 22, 722, DateTimeKind.Local).AddTicks(9024),
            ...
            modelBuilder.Entity("CabifyTransportBooking.Shared.Domain.VehicleCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Capacity = 4,
                            CreatedBy = "System",
                            DateCreated = new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(2924),
                            DateUpdated = new DateTime(2023, 2, 7, 14, 57, 22, 723, DateTimeKind.Local).AddTicks(2932),
